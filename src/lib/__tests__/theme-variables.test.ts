...
const mockThemeVariables = {
  ...
  '--radius': '0rem',
  '--font-sans': 'Roboto-MediumItalic, system-ui, sans-serif',
...
describe('Theme Variables', () => {
  ...
  test('should have proper font variables', () => {
    ...
    const fontVariables = ['--font-sans', '--font-logo'];
...
describe('Theme Performance', () => {
  ...
  test('should have minimal CSS bundle impact', () => {
    ...
    const themeStyles = styleSheets.filter(
      sheet =>
  ...
  test('should have optimized font loading', () => {
    ...
    const fontFamily = 'Roboto-MediumItalic, system-ui, sans-serif';
    const testElement = document.createElement('div');
