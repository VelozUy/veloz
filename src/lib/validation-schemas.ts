...
export const contactFormSchema = z.object({
  ...
  eventType: z.enum(['wedding', 'corporate', 'birthday', 'quinceañera', 'other']).optional(),
...
export const contactMessageSchema = baseSchema.extend({
  ...
  status: z.enum(['new', 'in_progress', 'completed', 'archived']).default('new'),
...
export const projectSchema = baseSchema.extend({
  ...
  eventType: z.enum(['wedding', 'corporate', 'birthday', 'quinceañera', 'other']),
...
export const homepageContentSchema = baseSchema.extend({
  ...
  backgroundVideos: z.array(z.object({
    url: z.string().url(),
    thumbnail: z.string().url().optional(),
...
export type EmailNotificationPreferencesData = z.infer<typeof emailNotificationPreferencesSchema>;
...
export const validateContactMessage = (data: unknown) => contactMessageSchema.parse(data);
...
export const validateProjectMedia = (data: unknown) => projectMediaSchema.parse(data);
export const validateHomepageContent = (data: unknown) => homepageContentSchema.parse(data);
...
export const safeValidateContactMessage = (data: unknown) => contactMessageSchema.safeParse(data);
...
export const safeValidateProjectMedia = (data: unknown) => projectMediaSchema.safeParse(data);
export const safeValidateHomepageContent = (data: unknown) => homepageContentSchema.safeParse(data);
export const safeValidateAdminUser = (data: unknown) => adminUserSchema.safeParse(data); 