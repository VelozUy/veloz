    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Comprehensive testing suite to verify application functionality across
          different browsers.
        </p>
      </div>
      ...
      <Tabs defaultValue="automated" className="w-full">
            ...
            <Card>
              <CardContent className="py-8">
                <div className="text-center text-gray-500">
                  <p>
                    No test results yet. Click &quot;Run Comprehensive
                    Tests&quot; to start testing.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="manual" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {Object.entries(manualTestingChecklist).map(
              ([browser, checklist]) => (
                <Card key={browser}>
                  <CardHeader>
          ...
          <div className="space-y-4 text-sm">
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 text-gray-600">
                <li>
                  Click &quot;Run Comprehensive Tests&quot; to execute automated
                  tests
                </li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 text-gray-600">
                ...
                <li>
                  Use the &quot;Quick Navigation Tests&quot; buttons to test
                  different pages
                </li>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 text-gray-600">
                ...
                <li>
                  Go to the &quot;Performance&quot; or &quot;Timeline&quot; tab
                </li>
                <li>Record a page load and review the metrics</li>
                <li>
                  Check the &quot;Lighthouse&quot; tab for SEO and accessibility
                  scores
                </li>
                <li>
                  Review the &quot;Network&quot; tab for loading times and asset
                  sizes
                </li>
              </ol>
            </div>
