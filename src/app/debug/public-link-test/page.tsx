...
export default function PublicLinkTestPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="mb-6">
        Test the public link functionality with these pre-generated links:
      </p>
      ...
      <div className="mt-8 p-4 bg-muted border border-border rounded">
        ...
        <ul className="text-sm space-y-1">
          <li>
            ✅ <strong>Public Link:</strong> Should show blue debug box + toggle
            buttons
          </li>
          <li>
            ✅ <strong>Regular Link:</strong> Should show only signup form (no
            toggle)
          </li>
          <li>
            ✅ <strong>Both:</strong> Should show project information on the
            left
          </li>
          <li>
            ✅ <strong>Debug Info:</strong> Should show isPublic: true and
            isSignIn: false
          </li>
        </ul>
      </div>
