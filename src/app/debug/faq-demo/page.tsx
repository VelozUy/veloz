...
const mockFAQs = [
  {
    ...
    answer:
      'Ofrecemos servicios completos de fotografía y videografía para eventos sociales, corporativos y culturales.',
    order: 1,
  },
  {
    id: '2',
    ...
    answer:
      'Nuestros precios varían según el tipo de evento, duración y paquete seleccionado. Contáctanos para una cotización personalizada.',
    order: 2,
  },
  {
    id: '3',
    ...
    answer:
      'Utilizamos equipos profesionales de última generación, incluyendo cámaras Canon y Sony de alta resolución.',
    order: 3,
  },
  {
    id: '4',
    ...
    answer:
      'El tiempo de entrega varía según el tipo de proyecto, pero generalmente entregamos en 2-3 semanas.',
    order: 4,
  },
  {
    id: '5',
    ...
    answer:
      'Sí, cubrimos todo el territorio uruguayo y también realizamos trabajos en el exterior.',
    order: 5,
  },
  {
    id: '6',
    ...
    answer:
      'Sí, todos nuestros paquetes incluyen edición profesional y retoque de imágenes.',
    order: 6,
  },
  {
    id: '7',
    ...
    answer:
      'Absolutamente, tenemos experiencia en eventos nocturnos y disponemos de equipos especializados para condiciones de poca luz.',
    order: 7,
  },
  {
    id: '8',
    ...
    answer:
      'Sí, ofrecemos servicios de videografía con drone para tomas aéreas espectaculares.',
    order: 8,
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main style={{ paddingTop: '4rem' }}>
        ...
        <div className="bg-background text-foreground">
          <div className="mx-auto max-w-7xl px-16 py-24">
            ...
            <p className="mt-6 text-xl text-muted-foreground max-w-3xl">
              Demostración del nuevo sistema de FAQ con pestañas adhesivas
        ...
        <FAQSection faqs={mockFAQs} title="Preguntas Frecuentes" locale="es" />
