...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 md:px-8 lg:px-8 xl:px-16 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Withdrawal of Consent:</strong> Withdraw consent for data
              processing
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-muted p-4 rounded-none mt-4">
            ...
            <p>
              <strong>Address:</strong> Montevideo, Uruguay
            </p>
            <p>
              <strong>Phone:</strong> +598 [Phone Number]
            </p>
          </div>
        </section>
