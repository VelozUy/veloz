...
export default function CrewManagementPage() {
    ...
    try {
      ...
      for (const project of projects) {
        if (project.crewMembers?.includes(memberId)) {
          const updatedCrewMembers = project.crewMembers.filter(
            id => id !== memberId
          );
  ...
  const getCrewMemberAssignments = (memberId: string) => {
    return projects.filter(project => project.crewMembers?.includes(memberId));
  };
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end space-x-1">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                router.push(`/admin/crew/${member.id}/edit`)
                              }
                            >
