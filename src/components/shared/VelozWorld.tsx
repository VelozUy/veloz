export function VelozWorld({
  variant = 'world-2',
  size = 'default',
}: {
  variant?: 'world-1' | 'world-2' | 'world-3';
  ...
  return (
    <div className="flex items-center justify-center">{renderWorld()}</div>
  );
}
