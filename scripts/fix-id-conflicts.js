...
async function findAndFixIdConflicts() {
  try {
      ...
      try {
        ...
        if (numericIds.length > 0) {
          ...
          if (numericIds.includes('4')) {
            ...
            console.log(`   💡 To fix this, you can manually delete the document with ID "4" from the ${collectionName} collection in Firebase Console`);
            console.log(`   🔗 Firebase Console: https://console.firebase.google.com/project/${firebaseConfig.projectId}/firestore/data/${collectionName}/4`);
          }
        }
    ...
    if (!foundConflicts) {
      ...
      console.log('   4. A component trying to create documents with specific IDs');
    }
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log('');
      console.log('Usage:');
      console.log('  node scripts/fix-id-conflicts.js find           - Find potential ID conflicts');
      console.log('  node scripts/fix-id-conflicts.js clear-homepage - Clear and recreate homepage content');
      console.log('  node scripts/fix-id-conflicts.js fix            - Find conflicts and fix homepage');
      console.log('');
